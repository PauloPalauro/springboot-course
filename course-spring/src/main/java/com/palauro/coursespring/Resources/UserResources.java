...
public class UserResources {
    ...
    public ResponseEntity<User> insert(@RequestBody User obj) { // @RequestBody = Dizer que vai chegar um objeto "JSON" e que ele será deserializado para um objeto "User"
